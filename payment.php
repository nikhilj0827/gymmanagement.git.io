...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="img/TTT.png">
            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.html"><img src="img/TTT.png" height="150px" width="150px" alt=""></a>
                        </div>
                        <!-- Main-menu -->
...
<main>
    <!-- payment form start -->
<br><br>
    <section style="background-color: #f9c9aa; margin-top: 150px;">
        ...
        <div class="card">
          ...
          <div class="rounded-bottom" style="background-color: #eee;">
            <div class="card-body">
              ...
              <button class="btn btn-info btn-block">Pay now</button>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="col-xl-12">
                        <div class="single-footer-caption mb-50 text-center">
                            ...
                            <div class="footer-logo wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                                <a href="index.html"><img src="img/TTT.png" alt=""></a>
                            </div>
                            <!-- Menu -->
                            <!-- Header Start -->
                    ...
                    <div class="col-lg-12">
                        <div class="footer-copy-right text-center">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> <a href="https://www.TuitionsTonight.com" target="_blank">NS Fitness Club</a>
